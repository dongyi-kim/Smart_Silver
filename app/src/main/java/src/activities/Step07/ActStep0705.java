...
public class ActStep0705 extends StageActivity {
    ...
    public class Step0705DataSet {
        ...
        private final String arrDescription[][] = {
                {"아래 영수증은 진료비 계산서입니다.\n김 할머니가 내야 할 병원비는 모두 얼마입니까. 금액을 누르세요.", "아래 영수증은 진료비 계산서입니다.\n김 할머니가 맞은 주사의 금액은 영수증 어디에 있는지 찾아보세요.", "아래 영수증은 진료비 계산서입니다.\n김 할머니의 진찰료는 얼마인지 찾아 누르세요."},
                {"아래 영수증은 진료비 계산서입니다.\n김 할머니가 내야 할 병원비 중에서 식대는 얼마인지, 아래 영수증에서 찾아 누르세요.", "아래 영수증은 진료비 계산서입니다.\n김 할머니가 내야 할 병원비 중에서 검사료는 얼마인지, 아래 영수증에서 찾아 누르세요.", "아래 영수증은 진료비 계산서입니다.\n김 할머니가 내야 할 병원비 중에서 입원비는 얼마인지, 아래 영수증에서 찾아 누르세요."},
                {"아래 영수증은 진료비 계산서입니다.\n김 할머니가 내야 할 병원비 중에서 선택 진료료는 얼마가 나왔는지, 아래 영수증에서 찾아 누르세요.", "아래 영수증은 진료비 계산서입니다.\n김 할머니가 내야 할 병원비 중에서 투약 및 조제료(약값)로는 모두 얼마가 나왔는지, 영수증에서 찾아 누르세요.", "아래 영수증은 진료비 계산서입니다.\n김 할머니가 내야 할 병원비 중에서 영상진단 및 방사선치료비는 모두 얼마가 나왔는지, 아래 영수증에서 찾아 누르세요."},
                {"아래 고지서는 건강보험료 고지서입니다.\n김영자씨의 이번 달 보험료는 얼마인지 누르세요.", "아래 고지서는 건강보험료 고지서입니다.\n김영자씨의 보험료는 언제 사용한 것인지 찾아 누르세요.", "아래 고지서는 건강보험료 고지서입니다.\n김영자씨의 ‘납부자 번호’를 찾아 누르세요."},
                {"아래 고지서는 건강보험료 고지서입니다.\n김영자씨는 이번 달 보험료를 언제까지 납부해야 하는지 아래 고지서에서 찾아 누르세요.", "아래 고지서는 건강보험료 고지서입니다.\n김영자씨는 보험료를 납부기한까지 내지 못했습니다. 납기 후 금액은 얼마인지 찾아 누르세요.", "아래 고지서는 무엇에 관한 고지서인지 찾아 누르세요."}
        };
