...
public class ActStep0704 extends StageActivity {
    ...
    public class Step0704DataSet {
        ...
        private final String arrDescription[][] ={
                {"전기요금 납기일을 나타내는 곳을 찾아 누르세요.", "전기요금 납기일을 나타내는 곳을 찾아 누르세요.","전기요금 납기일을 나타내는 곳을 찾아 누르세요."},
                ...
                {"아래 영수증은 평생마트 영수증입니다.\n모듬 버섯 불고기는 얼마인지 찾아 누르세요.", "아래 영수증은 평생마트 영수증입니다.\n지불할 금액은 모두 얼마인지 찾아 누르세요.","아래 자료는 평생마트 영수증입니다.\n상추는 얼마인지 찾아 누르세요."},
                {"아래 영수증은 평생마트 영수증입니다.\n평생마트에서 물건을 산 날짜는 언제인지 찾아 누르세요.", "아래 영수증은 평생마트 영수증입니다.\n평생마트에서 물건을 산 날짜는 언제인지 찾아 누르세요.","아래 자료는 평생마트 영수증입니다.\n오렌지 주스를 몇 개 샀는지 수량을 찾아 누르세요."}
        };
