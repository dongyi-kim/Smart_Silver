...
public class ActStep0305 extends StageActivity{
    ...
    public class Step0305DataSet {
        private final String arrDiscriptionList[] = {" 할머니와 할아버지는 마당놀이를 보러 갔습니다. 할아버지는 입장료로 50,000원을 냈습니다. 마당놀이 1인 입장료는 15,000원 입니다. 할머니와 할아버지의 입장권을 산 후 받아야 할 거스름돈은 얼마입니까? 아래 단추를 누르세요.",
                " 김할아버지가 할머니에게 동전지갑을 선물하려고 합니다. 할아버지는 10,000원을 냈습니다. 동전지갑은 3,000원입니다. 받아야 할 거스름돈은 얼마입니까? 아래 단추를 누르세요.",
                " 예쁜이 할머니는 할아버지와 함께 순대국을 먹고 15,000원을 냈습니다. 순대국은 6,000원입니다. 할머니가 할아버지의 순대국 값을 모두 지불한다면, 받아야 할 거스름돈은 얼마입니까? 아래 단추를 누르세요",
                " 할머니와 할아버지는 마당놀이를 보러 갔습니다. 할아버지는 입장료로 50,000원을 냈습니다. 마당놀이 1인 입장료는 15,000원 입니다. 받아야 할 거스름돈은 얼마입니까? 아래 단추를 누르세요.",
                " 오늘의 데이트 비용을 알아봅시다! 할아버지는 할머니와 같이 마당놀이를 함께 보고, 순대국을 먹고, 할머니에게 동전지갑을 선물했습니다. 오늘 데이트 비용은 모두 얼마가 필요합니까? 아래 단추를 누르세요."};
