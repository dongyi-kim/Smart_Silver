...
public class ActStep0303 extends StageActivity{
    ...
    public class Step0303DataSet{
        ...
        private final int arrSampleCount[][][][] = {{{{5}, {7}}, {{24}, {30}}, {{5, 10}, {5, 10}}, {{20, 40}, {5, 5}}},
                {{{7}, {8}}, {{25}, {25}}, {{2, 3}, {5, 10}}, {{10, 20}, {3, 7}}},
                {{{8}, {9}}, {{32}, {40}}, {{2, 3}, {3, 2}}, {{15, 10}, {10, 5}}}};
        private final String arrFoodKind[][] = {{"홍시"}, {"밤"}, {"깨송편", "콩송편"}, {"녹두전", "호박전"}};
