...
public class ActStep0905 extends StageActivity {
    ...
    public synchronized void goNext(Object object){
        Intent intent = new Intent(this, ActStep10.class);
    ...
    public class Step0905DataSet{
        ...
        private final int imgset[][] = {
                ...
                {R.drawable.map_9_5_1,R.drawable.map_9_5_4,R.drawable.map_9_5_3},
        ...
        private final String btnset[][][] = {{{"1가지", "2가지", "3가지"},{"1가지", "2가지", "3가지"},{"1가지", "2가지", "3가지"}},
                {{"1가지", "2가지", "3가지"},{"2가지", "4가지", "6가지"},{"1가지", "2가지", "3가지"}},
