...
public class ActStep0804 extends StageActivity {
    ...
    public class Step0804DataSet {
        ...
        private final String deslist[][] = {{"다음은 9호선 김포공항으로 가는 급행열차 시간표에 대한 안내문입니다. 가장 많은 기차가 배치된 시간대는 언제인가요?",
                "다음은 9호선 신논현으로 가는 급행열차 시간표에 대한 안내문입니다. 가장 많은 기차가 배치된 시간대는 언제인가요?",
                "다음은 9호선 주말 급행열차 시간표에 대한 안내문입니다. 가장 많은 열차가 배치된 시간대는 언제인가요?",},

                {"다음은 9호선 김포공항으로 가는 급행열차 시간표에 대한 안내문입니다. 가장 적은 기차가 배치된 시간대는 언제인가요?",
                        "다음은 9호선 신논현으로 가는 급행열차 시간표에 대한 안내문입니다. 가장 적은 열차가 배치된 시간대는 언제인가요?",
                        "다음은 9호선 주말 급행열차 시간표에 대한 안내문입니다. 가장 적은 열차가 배치된 시간대는 언제인가요?",},

                {"다음은 9호선 김포공항으로 가는 급행열차 시간표에 대한 안내문입니다. 오후 7시 대에는 몇 개의 기차가 배차되어 있나요?",
                        "다음은 9호선 신논현으로 가는 급행열차 시간표에 대한 안내문입니다. 오전 8시 대에는 몇 개의 열차가 배차되어 있나요?",
                        "다음은 9호선 주말 급행열차 시간표에 대한 안내문입니다. 오후 2시 대에는 몇 대의 열차가 배차되어 있나요?",},

                {"다음은 9호선 김포공항으로 가는 급행열차 시간표에 대한 안내문입니다. 오후 4시 대에는 몇 개의 기차가 배차되어 있나요?",
                        "다음은 9호선 신논현으로 가는 급행열차 시간표에 대한 안내문입니다. 오전 11시 대에는 몇 개의 열차가 배차되어 있나요?",
                        "다음은 9호선 주말 급행열차 시간표에 대한 안내문입니다. 오후 8시 대에는 몇 대의 열차가 배차되어 있나요?",},

                {"다음은 9호선 김포공항으로 가는 급행열차 시간표에 대한 안내문입니다. 첫 차는 몇 시 몇 분에 있나요?",
                        "다음은 9호선 신논현으로 가는 급행열차 시간표에 대한 안내문입니다. 첫 차는 몇 시 몇 분에 있나요?",
                        "다음은 9호선 주말 급행열차 시간표에 대한 안내문입니다. 가장 늦게 운행하는 열차는 몇 시 몇 분에 있습니까?",},};
