...
public class Step0603DataSet {
    ...
    private static final String DiscriptionList[] = {
            "아래 과일의 수만큼 오른쪽 표에 스티커를 붙여봅시다. 감과 사과의 갯수만큼 화살표를 누르세요.",
            "아래 과일의 수만큼 오른쪽 표에 스티커를 붙여봅시다. 감과 밤의 갯수만큼 화살표를 누르세요.",
            "아래 도형의 수만큼 오른쪽 표에 스티커를 붙여봅시다. 동그라미, 네모의 갯수만큼 화살표를 누르세요.",
            "다음 표는 어떤 평생학교의 학생이 태어난 달을 표시한 것입니다. 가장 많이 태어난 달은 몇 월인가요?",
            "다음 표는 어떤 평생학교 학생 집의 분리수거 하는 요일을 표시한 것입니다. 분리수거를 가장 많이 하는 요일은 무엇인가요?"
    };
