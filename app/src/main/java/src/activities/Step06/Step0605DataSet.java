...
public class Step0605DataSet {
    ...
    private static final String DiscriptionList[][] = {
            {" 아래 그림은 내일의 비올 확률입니다. 대구지역의 내일 오후 비올 확률은 얼마인가요?"," 아래 그림은 내일의 비올 확률입니다. 대전지역의 내일 오전 비올 확률은 얼마인가요?"," 아래 그림은 내일의 비올 확률입니다. 청주지역의 내일 오전 비올 확률은 얼마인가요?",},
            {" 아래 그림은 내일의 비올 확률입니다. 청주지역의 내일 오후 비올 확률은 얼마인가요?"," 아래 그림은 내일의 비올 확률입니다. 전주지역의 내일 오후 비올 확률은 얼마인가요?"," 아래 그림은 내일의 비올 확률입니다. 부산지역의 내일 오후 비올 확률은 얼마인가요?",},
            {" 아래 그림은 내일의 비올 확률입니다. 광주지역의 내일 오전 비올 확률은 얼마인가요?"," 아래 그림은 내일의 비올 확률입니다. 서울지역의 내일 오전 비올 확률은 얼마인가요?"," 아래 그림은 내일의 비올 확률입니다. 춘천지역의 내일 오전 비올 확률은 얼마인가요?",},
            {" 아래 그림은 내일의 비올 확률입니다. 제주지역의 내일 오후 비올 확률은 얼마인가요?"," 아래 그림은 내일의 비올 확률입니다. 제주지역의 내일 오전 비올 확률은 얼마인가요?"," 아래 그림은 내일의 비올 확률입니다. 독도지역의 내일 오전 비올 확률은 얼마인가요?",},
