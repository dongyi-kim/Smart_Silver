...
public class Step0605DataSet {
    ...
    private static final String DescriptionList[][] = {
            {"다음 표에서 봄에 해당되는 개월 수는 몇 개월인가요?",
                    "다음 표에서 여름에 해당되는 개월 수는 몇 개월인가요?",
                    "다음 표에서 봄에 해당되는 개월 수는 몇 개월인가요?"},
            {"다음은 어느 해의 달력입니다. 목요일이 되는 날짜는 몇 개입니까?",
                    "다음은 어느 해의 달력입니다. 월요일이 되는 날짜는 몇 개입니까?",
                    "다음은 어느 해의 달력입니다. 일요일이 되는 날짜는 몇 개입니까?"},
            {"다음 표에서 3월부터 5월은 무슨 계절입니까?",
                    "다음 표에서 9월부터 11월은 무슨 계절입니까?",
                    "다음 표에서 6월부터 8월은 무슨 계절입니까?"},
            {"다음 표에서 3월부터 8월까지는 몇 개의 계절이 지났습니까?",
                    "다음 표에서 6월부터 11월까지는 몇 개의 계절이 지났습니까?",
                    "다음 표에서 3월부터 11월까지는 몇 개의 계절이 지났습니까?"},
            {"다음 그림에서 하루 중 오전은 모두 몇 시간입니까?",
                    "다음 그림에서 하루 중 오전은 모두 몇 시간입니까?",
                    "다음 그림에서 12시부터 24시까지는 어디에 해당되나요?", }
    };
