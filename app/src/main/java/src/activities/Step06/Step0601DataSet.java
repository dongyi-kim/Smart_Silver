...
/**
 * Created by jhobo_000 on 2015-05-19.
 */
...
public class Step0601DataSet {
    ...
    private static final String DiscriptionList[] = {
            "다음 자료는 1주일이 모두 며칠로 이루어져 있는지 나타내는 자료입니다. 다음 자료에서 1주일은 며칠입니까? 단추를 누르세요!",
            "다음 자료는 1년이 모두 몇 개월로 이루어져 있는 지 나타내고 있습니다. 다음 자료에서 봄은 모두 몇 개월인지 누르세요!",
            "다음 자료는 1년이 모두 몇 개월로 이루어져 있는지 나타내는 자료입니다. 다음 자료에서 1년은 모두 몇 개월인지 단추를 누르세요!",
            "1년의 계절은 모두 개 인지 누르세요!",
            "오전이란 자정(밤12시)부터 정오(낮12시)까지의 시간이라고 합니다. \n 다음 자료에서 하루 중 오전은 모두 몇 시간인지 단추를 누르세요!"
    };
