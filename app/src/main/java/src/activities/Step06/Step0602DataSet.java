...
public class Step0602DataSet {
    ...
    private static final String DiscriptionList[][] = {
            {"다음 자료는 김할머니의 하루 일과를 나타낸 일과표입니다. 김할머니는 하루에 아침운동을 몇 시간씩 하는지 아래 자료에서 찾아 단추를 누르세요!","다음 그림에서 김 할머니의 점심식사를 시작하는 시간은 몇 시 인가요?","다음 그림에서 김 할머니의 저녁식사를 시작하는 시간은 몇 시 인가요?"},
            ...
            {"다음 그림은 예쁜이 할머니의 하루 일과를 나타낸 것입니다. 예쁜이 할머니가 하루 중 가장 많은 시간을 보내는 것은 무엇인가요?", "다음 그림은 예쁜이 할머니의 하루 일과를 나타낸 것입니다. 예쁜이 할머니가 하루 중 가장 많은 시간을 보내는 것은 무엇인가요?", "다음 그림은 예쁜이 할머니의 하루 일과를 나타낸 것입니다. 예쁜이 할머니가 하루 중 가장 많은 시간을 보내는 것은 무엇인가요?"},
            {"다음 그림은 예쁜이 할머니의 하루 일과를 나타낸 것입니다.예쁜이 할머니가 하루 중 가장 적은 시간을 보내는 것은 무엇인가요?", "다음 그림은 예쁜이 할머니의 하루 일과를 나타낸 것입니다.예쁜이 할머니가 하루 중 가장 적은 시간을 보내는 것은 무엇인가요?", "다음 그림은 예쁜이 할머니의 하루 일과를 나타낸 것입니다.예쁜이 할머니가 하루 중 가장 적은 시간을 보내는 것은 무엇인가요?"}
    };
